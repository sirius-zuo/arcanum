...
```yaml
# docker-compose.yml (production services only)
services:
  postgres:
...
Replace the dev stores with production equivalents:
...
|---|---|---|
| `ARCANUM_AUTH_SECRET` | Yes | 32+ character secret for token signing |
