...
//!
//! Product + support search — Standard ingestion, ParallelFusion retrieval (RRF).
//! Both Vector and BM25 run on every query; RRF fuses the result lists.
//!
//! Run:
